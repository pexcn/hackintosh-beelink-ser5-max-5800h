 ...
 *
 * Disassembly of C:/Users/Administrator/Desktop/iasl/DSDT.aml
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x00008D01 (36097)
 *     Revision         0x02
 *     Checksum         0x0D
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I "
...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I ", 0x01072009)
{
    ...
    Name (DTPT, Zero)
    Name (TTDP, One)
    Name (TPMB, 0xCC383000)
    Name (TPBS, 0x4000)
    Name (TPMC, 0xCC387000)
    Name (TPCS, 0x4000)
    Name (TPMM, 0xFD210510)
    Name (FTPM, 0xFD210510)
    Name (PPIM, 0xCC5A9D98)
    Name (PPIL, 0x1C)
    Name (AMDT, One)
    Name (TPMF, One)
    Name (PPIV, One)
    ...
    Name (VGAF, One)
    OperationRegion (GNVS, SystemMemory, 0xCC5A9E18, 0x0E)
        ...
        Device (PCI0)
        {
            ...
            Device (SBRG)
            {
                ...
                Device (SIO1)
                {
                    ...
                    OperationRegion (HWID, SystemIO, HW1O, 0x02)
                    Field (HWID, ByteAcc, NoLock, Preserve)
                    {
                        HWIN,   8, 
                        HWDA,   8
                    }
                    ...
                    IndexField (HWIN, HWDA, ByteAcc, NoLock, Preserve)
                    {
                        Offset (0x99), 
                        HWT9,   8
                    }
